...
const ContactForm = ({setErrorMessage, toggleAlert, setAlertType}) => {
  ...
  return (
    <div className="grid sm:grid-cols-2 w-[95%] rounded-lg h-full items-start gap-16 mt-48 p-10 mx-auto bg-[#8AA29E] dark:bg-[#476B6B] font-reddit">
    
    <div className="md:py-10">
      <div className="flex flex-col md:items-start items-center">
          <h1 className="text-gray-800 text-3xl font-extrabold">Reach Out!</h1>
          <p className="text-sm dark:text-gray-300 text-gray-500 mt-4 w-2/3">I am curious, what's on your mind? Like I said earlier, feel free to reach out about anything. </p>
      </div>

        <div className="mt-12 flex flex-col md:items-start items-center">
        ...
        <div className="mt-12 flex flex-col md:items-start items-center">
            ...
            <ul className="flex mt-4 space-x-4">
                ...
                <li className="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0 cursor-pointer">
                  <a href="https://www.instagram.com/jw.aguirre/" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='currentColor' className="text-black"
                            viewBox="0 0 24 24">
                            <path
