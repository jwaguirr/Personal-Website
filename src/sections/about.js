            ...
            <div className='w-full space-y-8 lg:space-y-0 md:w-1/3 flex flex-col p-3 lg:flex-grow  rounded-l-lg border-2 dark:border-white border-black'>
              ...
              <div className='flex justify-center items-center font-reddit text-center h-full '>
                <div className='relative corner-borders w-5/6 p-2'>
                    I like to think that one of the reasons I got into computer science was in an attempt to solve an unsolvable puzzle. The thought of being able to create a solution to any problem is mind-blowing!
                </div>
              </div>
            </div>
