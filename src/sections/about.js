...
function About() {
    ...
    // Defining the inviews for different parts of the about section. 

    // Learning in view is for the learning text
    const [learningRef, leaningInView] = useInView({
        triggerOnce: true,
        threshold: .1
    })

    // For the fisherman svg
      ...
      <div ref = {learningRef} className='h-full lg:p-5 flex flex-col justify-between items-center lg:px-12 w-full '>
        ...
        <animated.div style={learningSpring} className='flex justify-center items-center mt-6 w-full relative'>
          ...
          <div className='flex z-30 duration-500 bg-[#F5F5DC] dark:bg-[#2C2C2C] shadow-xl flex-col md:flex-row w-[90%] lg:w-3/4 text-[#4B3F3A] dark:text-[#EAE3D2]'>
            <div className='w-full space-y-8 lg:space-y-0 md:w-1/3 flex flex-col p-3 lg:flex-grow  rounded-l-lg border-2 dark:border-white border-black'>
              <div className='flex flex-row text-2xl font-reddit'>
                ...
                <div className='w-full px-2'>I really enjoy a good hike</div>
              </div>
            ...
            <div className='w-full md:w-1/3 flex  space-y-8 lg:space-y-0  flex-col p-3 lg:flex-grow  border-r-2 border-l-2 sm:border-r-0 sm:border-l-0 sm:border-t-2 sm:border-b-2 dark:border-white border-black '>
              ...
              <div className='flex justify-center items-center font-reddit text-center h-full '>
                <div className='relative corner-borders w-5/6 p-2'>
                    The first project that got me into computer science was actually an autonomous RC car. This car used HC-SR04 ultrasonic sensors controlled with an L298 motor controller and Arduino.                </div>
              </div>
            </div>
            <div className='w-full md:w-1/3 space-y-8 lg:space-y-0 rounded-r-lg flex flex-col p-3 lg:flex-grow xl:h-96 border-2 dark:border-white border-black'>
